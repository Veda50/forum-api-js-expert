...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('getRepliesByCommentId function', () => {
    it('should return empty replies when comment has no replies', async () => {
      // Arrange
      const replyRepositoryPostgres = new ReplyRepositoryPostgres(pool, {});
    ...
    it('should return replies correctly', async () => {
      ...
      await RepliesTableTestHelper.addReply({
        id: 'reply-123', commentId: 'comment-123', owner: 'user-123', content: 'reply A',
      });
      await RepliesTableTestHelper.addReply({
        id: 'reply-456', commentId: 'comment-123', owner: 'user-123', content: 'reply B',
      });
      const replyRepositoryPostgres = new ReplyRepositoryPostgres(pool, {});
      ...
      expect(replies[0].content).toEqual('reply A');
      expect(replies[1].id).toEqual('reply-456');
      expect(replies[1].username).toEqual('dicoding');
      expect(replies[1].content).toEqual('reply B');
    });
  });
});
