...
describe('CommentRepositoryPostgres', () => {
  ...
  describe('getCommentsByThreadId function', () => {
    it('should return empty comments when thread has no comments', async () => {
      // Arrange
      const commentRepositoryPostgres = new CommentRepositoryPostgres(pool, {});
    ...
    it('should return comments correctly', async () => {
      ...
      await CommentsTableTestHelper.addComment({
        id: 'comment-123', threadId: 'thread-123', owner: 'user-123', content: 'comment A',
      });
      await CommentsTableTestHelper.addComment({
        id: 'comment-456', threadId: 'thread-123', owner: 'user-123', content: 'comment B',
      });
      const commentRepositoryPostgres = new CommentRepositoryPostgres(pool, {});
      ...
      expect(comments[0].content).toEqual('comment A');
      expect(comments[1].id).toEqual('comment-456');
      expect(comments[1].username).toEqual('dicoding');
      expect(comments[1].content).toEqual('comment B');
    });
  });
});
